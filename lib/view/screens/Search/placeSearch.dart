...
//         (element) => element.SiteName!.toLowerCase().contains(value.toLowerCase()) 
//         ).toList();
...
//                                           onPressed: () {
//                                             Get.to(PlaceDetails(
//                               placeId: placesList[index].id!,
//                               name: placesList[index].SiteName!,
//                               location: placesList[index].Location!,
//                               description: placesList[index].Details!,
//                               ));
//                                           },
//                                           child: Container(
//                                             child: ListTile(
