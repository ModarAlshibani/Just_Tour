...
class TourTrips extends StatefulWidget {
  const TourTrips({super.key});

  @override
  State<TourTrips> createState() => _TourTripsState();
}
...
class _TourTripsState extends State<TourTrips> {
  @override
                ...
                Positioned.fill(
                  ...
                  decoration: BoxDecoration(
                      image: DecorationImage(
                          image: NetworkImage('ss'), fit: BoxFit.cover),
                      borderRadius: BorderRadius.circular(10)),
                )),
                Positioned.fill(
                  child: Container(
