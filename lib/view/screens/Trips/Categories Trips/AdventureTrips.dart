...
class AdventureTrips extends StatefulWidget {
  const AdventureTrips({super.key});

  @override
  State<AdventureTrips> createState() => _AdventureTripsState();
}
...
class _AdventureTripsState extends State<AdventureTrips> {
  @override
